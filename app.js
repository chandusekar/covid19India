...
const covertStateDbObjectToResponseDbObject = (dbObject) => {
  return {
...
app.get("/states/", async (request, response) => {
  ...
  response.send(
    stateArray.map((eachState) =>
      covertStateDbObjectToResponseDbObject(eachState)
    )
  );
});
...
app.get("/states/:stateId/", async (request, response) => {
  ...
  response.send(covertStateDbObjectToResponseDbObject(state));
});
